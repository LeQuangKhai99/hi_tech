...
@section('js')
    ...
    <script src="/admin_file/js/slide/update.js"></script>
...
@section('content')
        ...
        <!-- /.content-header -->
        @include('admin.layout.content-header', ['title'=>"Danh sách slide", 'path_chird'=>['slide'], 'route'=>['slide.index']])
        <!-- Main content -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <button class="btn btn-primary float-lg-right mb-3" data-toggle="modal" data-target="#myModal">
                                <i class="fas fa-plus-square"></i> Thêm slide
                            </button>
                                ...
                                @foreach($slides as $value)
                                    <tr>
                                        ...
                                        <td style="text-align: center;" width="20%">
                                            <button title="Cập nhật" type="button" data-status="update" data-url="{{route('slide.update', ['id'=>$value->id])}}" class="btn btn-success act_update"><i class="fas fa-edit"></i></button>
                                            <button title="Xóa" type="button" data-url="{{route('slide.delete', ['id'=>$value->id])}}" class="btn btn-danger act-del"><i class="fas fa-trash-alt"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{route('slide.add')}}" enctype="multipart/form-data">
                                @csrf
        ...
        <div class="modal" id="myModal2">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal body -->
                    <div class="modal-body">
                        <form method="post" action="{{route('slide.postUpdate')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Hình ảnh</label>
